...
function [Lw, Rw]= obstacle_avoidance_FLC_corr(L_sensor, R_sensor, F_sensor)
    ...
    L_N= trianglar_fct( 0, 0.1, 0 , L_sensor, 'start'); 
    L_M= trianglar_fct( 0.05, 0.15, 0.25 , L_sensor, 'tria'); 
    L_F= trianglar_fct( 0.25, 0.3, 0 , L_sensor, 'end');    

    R_N= trianglar_fct( 0, 0.1, 0 , R_sensor, 'start'); 
    R_M= trianglar_fct( 0.05, 0.15, 0.25, R_sensor, 'tria'); 
    R_F= trianglar_fct( 0.25, 0.3, 0 , R_sensor, 'end');    


    F_N= trianglar_fct( 0, 0.1, 0, F_sensor, 'start');
    F_M= trianglar_fct( 0.05, 0.15, 0.25, F_sensor, 'tria');
    F_F= trianglar_fct( 0.25, 0.3, 0, F_sensor, 'end');
